...
export default function WeeklyReflection({
  ...
  return (
    <View className="absolute inset-0 items-center justify-center bg-black bg-opacity-50">
      <View
        className={`m-4 max-h-[90%] w-full max-w-md rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
      >
        <ScrollView className="p-6">
          ...
          <Card className="border-0">
            ...
            >
              <Text
                className={`mb-2 text-sm font-medium ${isDarkMode ? "text-gray-100" : "text-blue-800"}`}
              >
              ...
              <View className="flex-row items-center justify-between">
                <View className="flex-row items-center">
                  ...
                  />
                  <Text
                    className={`text-sm ${isDarkMode ? "text-gray-200" : "text-blue-700"}`}
                  >
                    {completedGoals}/{totalGoals} goals completed
                  </Text>
                </View>
                <Text
                  className={`text-sm font-semibold ${isDarkMode ? "text-emerald-400" : "text-blue-800"}`}
                >
          ...
          <View className="mb-4">
            ...
            <Text
              className={`mt-1 text-center text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}
            >
