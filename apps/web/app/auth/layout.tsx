  ...
  return (
    <div className='relative flex h-dvh w-full items-center justify-center overflow-hidden'>
      ...
      <div className='absolute inset-0 z-10'>
        <Image src='/images/auth-bg.webp' alt='Background' fill priority className='object-cover object-center' />
      </div>

      {/* Overlay */}
      <div className='absolute inset-0 bg-gradient-to-br from-white/80 to-white/40 backdrop-blur-[2px]' />

      <div className='relative z-10 mx-auto flex w-full flex-col'>{children}</div>
    </div>
  );
};
