            ...
            {activeTab === "orders" ? (
                    ...
                    >
                      <View>
                        ...
                        {order.trackingNumber && (
                          <View
                            className={`mb-3 rounded-lg p-3 ${isDarkMode ? "bg-emerald-950/50" : "bg-emerald-50"}`}
                          >
                            <Text
                            ...
                            <Text
                              className={`text-xs ${isDarkMode ? "text-emerald-400" : "text-emerald-700"}`}
                            >
              ...
              <>
                ...
                >
                  <View className="p-4">
                    <Text
                      className={`mb-4 text-lg font-semibold ${isDarkMode ? "text-gray-100" : "text-gray-800"}`}
                    >
                      All Supplements
                    </Text>
                    {supplements
