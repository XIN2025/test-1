...
const tabs = {
  ...
  Supplements: {
    title: 'Supplements',
    subtitle: 'Your health essentials',
    icon: Pill,
  },
  Rx: {
    title: 'Rx',
...
export default function OrdersPage() {
  ...
  const [activeTab, setActiveTab] = useState<keyof typeof tabs>('Products');
                                ...
                                >
                                  <Text
                                    className={`text-xs font-medium ${
                                      supplement.inStock ? 'text-white' : isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                    }`}
                                  >
