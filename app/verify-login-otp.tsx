...
export default function VerifyLoginOtpScreen() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prefsRes = await fetch(`${API_BASE_URL}/api/user/preferences?email=${encodeURIComponent(normalizedEmail)}`);
          ...
          >
            <View className='flex-1 items-center justify-center bg-green-50 px-4 py-8'>
              ...
              <View className='w-full max-w-md items-center rounded-xl bg-white p-8 shadow-lg'>
                <Text className='mb-2 text-center text-2xl font-bold'>Verify Login OTP</Text>
